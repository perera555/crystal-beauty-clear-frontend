                    ...
                    <div className="w-full h-full flex">
                        ...
                        <div className="w-1/2 h-full  flex flex-col items-center gap-4 p-10">
                            ...
                            <div className="w-full h-[40px] flex gap-4 mt-[60px]">
                                <button className="w-1/2 h-full bg-accent text-white font-semibold hover:bg-accent/80 ">Add to Cart</button>
                                <button className="w-1/2 h-full border border-accent text-accent font-semibold hover:bg-accent hover:text-white ">Buy Now</button>
