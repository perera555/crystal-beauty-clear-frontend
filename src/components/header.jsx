    ...
    return (
        <header className="w-full bg-accent h-[100px] text-white px-[40px]">
            <div className="w-full h-full flex relative ">
                <img src="/logo.png" className="hidden lg:block h-full w-[160px] left-0 absolute  object-cover" alt="" />
                <div className="w-full flex justify-center items-center relative lg:hidden">
                    <MdMenu className="absolute left-0 text-3xl"
                        onClick={() => setSidebaropen(true)}
                    />
                    <img src="/logo.png" className="  h-full w-[160px]    object-cover" alt="" />
                </div>
                {
                    issideBaropen &&
                    <div className="fixed top-0 left-0 w-full h-screen bg-[#00000080] text-secondary z-100">
                        ...
                        <div className="w-[300px] flex flex-col bg-primary h-full ">
                            <div className="w-full h-[100px] left-2 flex justify-center items-center relative lg:hidden bg-accent">
                                <MdMenu className="absolute  text-white left-0 text-3xl"
                ...
                <Link to="/cart" className="h-full absolute text-3xl hidden right-0 lg:flex justify-center items-center">
                    <BsCart3 />
                </Link>
